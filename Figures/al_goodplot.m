function [h, mu, sigma, q, notch] = al_goodplot(x, pos, boxw, col, type, bw, p, jitw, th)
    ...
    switch type
        case {'bilateral', 'man'}
            ...
            if nargin==9 && ~isempty(th)
                plot([pos(i)-boxw(i)/4 pos(i)+boxw(i)/4], [th(i,1) th(i,1)],'color','r','linewidth',1,'HandleVisibility','off');
                plot([pos(i)-boxw(i)/4 pos(i)+boxw(i)/4], [th(i,2) th(i,2)],'color','r','linewidth',1,'HandleVisibility','off');
            end
        ...
        case 'left'
            ...
            % plot th
            if nargin==9 && ~isempty(th)
                plot([pos(i)-boxw(i)/4 pos(i)], [th(i,1) th(i,1)],'color','r','linewidth',1,'HandleVisibility','off');
                plot([pos(i)-boxw(i)/4 pos(i)], [th(i,2) th(i,2)],'color','r','linewidth',1,'HandleVisibility','off');
            end
        ...
        case 'right'
            ...
            % plot th
            if nargin==9 && ~isempty(th)
                plot([pos(i) pos(i)+boxw(i)/4], [th(i,1) th(i,1)],'color','r','linewidth',1,'HandleVisibility','off');
                plot([pos(i) pos(i)+boxw(i)/4], [th(i,2) th(i,2)],'color','r','linewidth',1,'HandleVisibility','off');
            end
    end
end
grid on
